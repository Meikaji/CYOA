...
print("There are three pathways, although all three are poorly lit. Pick one, or face the concequences. (LEFT/RIGHT/STRAIGHT)")
...
if do == "RIGHT":
    ...
    if do == "EAT":
        ...
        if do == "YES":
            ...
            print("tH3 Th1nG 1s h3R3. (RUN/FACE THE CONCEQUENCES)")
